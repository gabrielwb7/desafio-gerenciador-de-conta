...
public class ResponseTransfer {
    ...
    public static ResponseTransfer responseTransfer(Operations operations) {
        return new ResponseTransfer(operations.getIdOperation(), operations.getTypeOperations(), operations.getDateOperation(), operations.getAmount(), operations.getTypeStatus(), operations.getAccountDestiny(),operations.getAgencyDestiny(), operations.getDestinyVerifyDigit());
    }
